...
export const VCODE_SEND_URL = BASE_URL + 'VCode/getVcode'
export const VCODE_SEND_URL2 = BASE_URL + 'login/sendvcode'
...
export const EMAIL_VERIFY_URL = BASE_URL + 'VCode/checkVCode'
