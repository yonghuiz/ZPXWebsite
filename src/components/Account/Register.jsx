...
import { Form, Input, Button, Card, Typography, Divider, message, Row, Col } from 'antd'
import { MailOutlined, LockOutlined, SafetyCertificateOutlined } from '@ant-design/icons';
import { showErrorMessage, showSuccessMessage, ModalBox } from './MessageBox.jsx';
...
class Register extends Component {
    ...
    sendVCode = () => {
        ...
        post_data1(LOGIN_CHECKEMAIL_URL, {
            ...
            post_data(VCODE_SEND_URL2, { email: email })
                .then((data) => {
