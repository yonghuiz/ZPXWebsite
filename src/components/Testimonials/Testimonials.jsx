...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      testimonial: 'Managing packages for 15,000 students was a nightmare before Zippora. Now everything is automated, secure, and efficient. Students and staff both love it.'
    },
    {
      id: 4,
      name: 'Lisa Thompson',
      ...
      <div className="testimonials__container">
        ...
        <div className="testimonials__grid">
          {testimonials.map((testimonial, index) => (
            <motion.div
              key={testimonial.id}
              className={`testimonials__card ${testimonial.featured ? 'testimonials__card--featured' : ''}`}
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="testimonials__stat">
            <div className="testimonials__stat-number">1000+</div>
