                ...
                <ModalBody>
                    {
                        ...
                        <span className='modal-error-ico'><i class="fa fa-times-circle"> </i></span>
                        :null
                    }
                     {
                        this.state[MODAL_TYPE] === MODAL_TYPE_INFO?
                        <span className='modal-info-ico'><i class="fa fa-info-circle"> </i></span>
                        :null
                    }
                    {
                        this.state[MODAL_TYPE] === MODAL_TYPE_CONFIRM?
                        <span className='modal-info-ico'><i class="fa fa-question-circle"> </i></span>
                        :null
                    }
                    {
                        this.state[MODAL_TYPE] === MODAL_TYPE_SUCESS?
                        <span className='modal-success-ico'><i class="fa fa-check-circle"> </i></span>
                        :null
                    }
